...
This chapter details the transformation functions in SecLang++.
...
> **Description:** Base64 扩展解码 (支持更多变体)
...
> **Description:** 规范化 Windows 路径 (英式拼写)
...
> **Description:** 跳过指定数量的规则

**信息:** Original Example: `skip:2`

**Syntax:** `skip | skip:value`
...
**Syntax:** `skipAfter | skipAfter:value`
...
> **Description:** 设置 HTTP 响应状态码

**信息:** Original Example: `status:403`

**Syntax:** `status | status:value`
...
> **Description:** 设置 XML 命名空间

**信息:** Original Example: `xmlns:ns=http://example.com`

**Syntax:** `xmlns | xmlns:value`
...
> **Description:** 修改请求体访问设置

**信息:** Original Example: `ctl:requestBodyAccess=On`

**Syntax:** `ctl:requestBodyAccess`
...
> **Description:** 强制将请求体放入变量

**信息:** Original Example: `ctl:forceRequestBodyVariable=On`

**Syntax:** `ctl:forceRequestBodyVariable`
...
> **Description:** 设置请求体处理器

**信息:** Original Example: `ctl:requestBodyProcessor=JSON`

**Syntax:** `ctl:requestBodyProcessor`
...
> **Description:** 修改审计引擎状态

**信息:** Original Example: `ctl:auditEngine=Off`

**Syntax:** `ctl:auditEngine`
...
> **Description:** 修改审计日志部分

**信息:** Original Example: `ctl:auditLogParts=+E`

**Syntax:** `ctl:auditLogParts`
...
> **Description:** 移除指定 ID 的规则

**信息:** Original Example: `ctl:ruleRemoveById=1001`

**Syntax:** `ctl:ruleRemoveById`
